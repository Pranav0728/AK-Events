    ...
    <section className="relative h-[88vh] min-h-[600px] w-full overflow-hidden mt-[82px]">
      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-center px-6 text-center">
        ...
        <h1 className="mt-8 max-w-4xl font-serif text-6xl font-light leading-[1.05] text-white md:text-7xl lg:text-8xl animate-fade-in-up">
          Creating Beautiful
          <em className="italic text-violet-400"> Celebrations</em>
        </h1>
        ...
        >
          From birthdays and baby showers to engagements, housewarming events,
          and private parties, AK Events creates stunning decorations that
          transform every occasion into a memorable celebration.
        </p>
      </div>
